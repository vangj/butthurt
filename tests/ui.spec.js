...
const exportLanguageCases = [
  ...
  { code: 'bn', whiner: 'রফিকুল ইসলাম', offender: 'মোঃ করিম' },
  { code: 'idn', whiner: 'Siti Nur', offender: 'Budi Santoso' },
  { code: 'sw', whiner: 'Asha Mwangi', offender: 'Juma Njoroge' },
  { code: 'ha', whiner: 'Amina Musa', offender: 'Sani Bello' },
  { code: 'yo', whiner: 'Ayọ̀déjì Adé', offender: 'Títílọlá Ọlá' },
  { code: 'ig', whiner: 'Chinedu Okafor', offender: 'Amaka Nwosu' },
  { code: 'am', whiner: 'ዳኛ ተስፋዬ', offender: 'ሚና አበበ' },
  { code: 'om', whiner: 'Lensa Bekele', offender: 'Tadesse Fayo' },
  { code: 'zu', whiner: 'Lindiwe Dlamini', offender: 'Sipho Khumalo' },
  { code: 'so', whiner: 'Hodan Ali', offender: 'Ahmed Warsame' },
  { code: 'sn', whiner: 'Tendai Moyo', offender: 'Rudo Chirwa' },
